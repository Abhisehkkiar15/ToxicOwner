    ...
    try:
        ...
        try:
            ...
            if user.status == "kicked":
                await message.reply_text("Sorry Sir, You are Banned. Contact My Support Group ")
                return 1
        except UserNotParticipant:
            try:
                url = await gen_link(app, update_channel)
                await message.reply_photo(
                    photo="https://graph.org/file/dbd48ba7093582ab20063.jpg",
                ...
                await message.reply_text(
                    ...
                    reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🤖 ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇs ᴄʜᴀɴɴᴇʟ 🤖", url="https://t.me/+J7kCukeM3z0zZmU1")]])
                )
            return 1
